...
export default function LocalHireApplyPage() {
  ...
  return (
    <SchoolPageShell
      eyebrow="Employment"
      title="Apply"
      subtitle="Share your details with the BIST recruitment team."
      heroImage="https://picsum.photos/id/20/1920/980"
      heroAlt="Candidate preparing a professional application"
      showVideo={false}
    >
      <div className="mt-14 rounded-3xl border border-zinc-200/80 bg-white/82 p-6 shadow-[0_18px_55px_rgba(26,31,75,0.09)] backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04] sm:p-8">
        <div className="flex flex-col gap-3 border-b border-zinc-200 pb-6 dark:border-white/10 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-[#C8102E] dark:text-[#C9A84C]">Local Hire Application</p>
