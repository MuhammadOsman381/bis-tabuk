  ...
  return (
    ...
    >
      <div className="mt-14 border-t border-zinc-200 pt-10 text-center dark:border-white/10">
        ...
        <p className="mx-auto mt-3 max-w-xl text-base font-semibold leading-7 text-zinc-600 dark:text-zinc-300">Send your details and CV to the BIST recruitment team for overseas hire opportunities.</p>
        <Link
          href="/employment/overseas-hire-benefits/apply"
