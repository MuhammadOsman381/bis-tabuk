...
export default function Button({ 
  ...
  const variants = {
    primary: "bg-[#C8102E] text-white shadow-lg shadow-[#C8102E]/20 hover:bg-[#9B0D23] hover:shadow-xl hover:shadow-[#C8102E]/25",
    outline: "border border-white/70 text-white hover:bg-white hover:text-[#1A1F4B] hover:border-white",
    ghost: "bg-white/10 backdrop-blur-md border border-white/25 text-white hover:bg-white/18"
  };
