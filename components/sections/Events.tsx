      ...
      <div className="max-w-7xl mx-auto px-6">
        <Reveal className="flex flex-col gap-5 sm:flex-row sm:justify-between sm:items-end mb-12">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mt-2 text-[#1A1F4B]">Upcoming Events</h2>
          </div>
          <a href="#" className="inline-flex items-center gap-2 text-[#C8102E] font-bold transition-all hover:translate-x-1">
              ...
              <div className="p-6 sm:p-8">
                <div className="flex gap-5 sm:gap-6">
                  <div className="text-center flex-shrink-0">
                    <div className="bg-[#1A1F4B] text-white w-16 h-16 rounded-2xl flex flex-col items-center justify-center shadow-lg shadow-[#1A1F4B]/15">
                      <div className="text-3xl font-bold">{event.day}</div>
                      <div className="text-xs -mt-1">{event.month}</div>
                    </div>
                    <div className="text-xs text-gray-400 mt-2">{event.year}</div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-bold text-[#1A1F4B] group-hover:text-[#C8102E] transition-colors">
                      {event.title}
                    </h3>
                    <p className="text-gray-600 mt-3 line-clamp-2">{event.desc}</p>

                    <div className="mt-6 space-y-2 text-sm text-gray-500">
                      <div className="flex items-center gap-2"><Clock className="h-4 w-4 text-[#C8102E]" /> {event.time}</div>
                      <div className="flex items-center gap-2"><MapPin className="h-4 w-4 text-[#C8102E]" /> {event.location}</div>
                    </div>

                    <a href="#" className="mt-6 inline-flex items-center gap-2 text-[#C8102E] font-bold transition-all hover:translate-x-1">
