        ...
        <div className="flex min-w-0 items-center">
          <Link href="/" className="flex min-w-0 items-center gap-2 rounded-2xl sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <span className="block max-w-32 truncate text-[10px] font-semibold leading-tight text-zinc-500 dark:text-zinc-400 sm:max-w-none sm:text-xs">British International School of Tabuk</span>
            </div>
          </Link>
        </div>
